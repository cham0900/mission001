...
function buildPlatformer(container, levelId) {
  document.getElementById("gameInstructions").textContent =
    "Arrow keys / WASD to move & jump. Search for hidden routes & collect all stars!";
  const W = 640,
    H = 380;
...
function buildDecode7(container, levelId) {
  document.getElementById("gameInstructions").textContent =
    'Caesar cipher +3 shift. Decode "WXQJWXQJVDKXU" → shift each letter back 3. Type the answer and submit.';
